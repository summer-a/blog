...
public class GeetestLib {
    ...
    private Logger log = LoggerFactory.getLogger(GeetestLib.class);
    ...
    private String getFailPreProcessRes() {
        ...
        String md5Str1 = CommonUtils.toMD5(rnd1 + "");
        String md5Str2 = CommonUtils.toMD5(rnd2 + "");
    ...
    private int registerChallenge(HashMap<String, String> data) {
        ...
        try {
            ...
            String return_challenge = jsonObject.getStr("challenge");

            gtlog("return_challenge:" + return_challenge);

            if (return_challenge.length() == 32) {

                this.responseStr = this.getSuccessPreProcessRes(CommonUtils.toMD5(return_challenge + this.privateKey));
    ...
    public int enhencedValidateRequest(String challenge, String validate, String seccode, HashMap<String, String> data) throws UnsupportedEncodingException {
        ...
        try {
            ...
            return_seccode = return_map.getStr("seccode");
            gtlog("md5: " + CommonUtils.toMD5(return_seccode));

            if (return_seccode.equals(CommonUtils.toMD5(seccode))) {
    ...
    public void gtlog(String message) {
        if (debugCode) {
            log.info("geetest log: " + message);
        }
    }

    protected boolean checkResultByPrivate(String challenge, String validate) {
        String encodeStr = CommonUtils.toMD5(privateKey + "geetest" + challenge);
